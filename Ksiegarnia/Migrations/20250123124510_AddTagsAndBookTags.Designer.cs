...
namespace Ksiegarnia.Migrations
{
    ...
    [Migration("20250123124510_AddTagsAndBookTags")]
    partial class AddTagsAndBookTags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ksiegarnia.Models.BookTag", b =>
                {
            ...
            modelBuilder.Entity("Ksiegarnia.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Ksiegarnia.Models.Book", b =>
                {
                    ...
                    b.HasOne("Ksiegarnia.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Ksiegarnia.Models.BookTag", b =>
                {
                    ...
                    b.HasOne("Ksiegarnia.Models.Tag", "Tag")
                        .WithMany("BookTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
